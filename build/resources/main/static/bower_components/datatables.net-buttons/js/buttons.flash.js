...
var ZeroClipboard_TableTools = {
	...
	dispatch: function(id, eventName, args) {
		// receive event from flash movie, send to clientPortail
	...
	register: function(id, client) {
		// register new clientPortail to receive events
	...
	Client: function(elem) {
		// constructor for new simple upload clientPortail
		this.handlers = {};
		...
		// register clientPortail with singleton to receive flash events
