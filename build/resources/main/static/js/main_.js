...
/*  $('.message-input').on('keypress', function (e) {
  ...
  if (typeof Chart !== 'undefined') {
    ...
    if ($("#pieChart1").length) {
      ...
      // pie chart data
      var pieData1 = {
        labels: ["Impayé", "En instance", "Yellow", "Payé", "Purple"],
        datasets: [{
...
/*    if ($("#donutChart").length) {
      ...
      // donut chart data
      var data = {
        labels: ["Impayé", "En instance", "Payé", ],
        datasets: [{
          data: [20, 150, 70],
    ...
    var donnees = function (impaye,instance,paye) {
        return {
            labels: ["Impayé", "En instance", "Payé", ],
            datasets: [{
                data: [impaye, instance, paye],
                backgroundColor: ["#f37070", "#5797fc",  "#4ecc48"],
                hoverBackgroundColor: ["#f37070", "#5797fc",  "#4ecc48"],
                borderWidth: 0
            }]
  ...
  function add_full_chat_message($input) {
    $('.chat-content').append('<div class="chat-message self"><div class="chat-message-content-w"><div class="chat-message-content">' + $input.val() + '</div></div><div class="chat-message-date">1:23pm</div><div class="chat-message-avatar"><img alt="" src="../img/favico.png"></div></div>');
    $input.val('');
