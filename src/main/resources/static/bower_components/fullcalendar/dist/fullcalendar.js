...
// NOTE: should use clientLeft/portailClientTop, but very unreliable cross-browser.
...
Calendar.mixin({
	...
	// Returns a moment for the current date, as defined by the clientPortail's computer or from the `now` option.
